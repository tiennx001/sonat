...
<strong>AP Mega Menu </strong> is a <strong> FREE WordPress plugin,</strong> for Mega Menu. With AP Mega Menu, you can easily add several widgets column wise, configure them and create great horizontal and vertical mega menu. 
...
[youtube https://www.youtube.com/watch?v=5ciF66eQ2KE]

[For More Video Tutorials Click Here](https://www.youtube.com/playlist?list=PLdSqn2S_qFxHLWS_ZcuGGh1SyWGP_llug)
...
[Plugin information](https://accesspressthemes.com/wordpress-plugins/ap-mega-menu/)

Plugin documentation: 
[Docs](https://accesspressthemes.com/documentation/ap-mega-menu/)

[Free Demo](http://demo.accesspressthemes.com/wordpress-plugins/ap-mega-menu/)

[Premium Demo](http://demo.accesspressthemes.com/wordpress-plugins/wp-mega-menu-pro/)

[Browse More WordPress Resources here!](http://wpall.club/)

== Themes Compatible with the Plugin: ==

<strong>AP Mega Menu </strong> works best with every WordPress theme. Its even more remarkable when used with popular themes like VMagazine and AccessPress Parallax.
...
[youtube https://www.youtube.com/watch?v=QI2DnI3xVwA&feature=youtu.be]
...
== Screenshots ==
1. Backend - General Settings & Mobile Settings
2. Backend - Image Default Settings
3. Backend - Shortcode Settings
4. Backend - Import/Export Settings
5. Backend - Custom CSS
6. Menu Settings - Enable AP Mega Menu Settings
7. Top Level Menu Settings - AP Mega Menu/Flyout Settings
8. Top Level Menu Settings - Add Widgets Settings
9. Top Level Menu Settings - General Settings 
10. Top Level Menu Settings - General Second Settings 
11. Top Level Menu Settings - Mega Menu Settings 
12. Top Level Menu Settings - Mega Menu Second  Settings 
13. Top Level Menu Settings - Flyout Settings 
14. Top Level Menu Settings - Menu Replacement Settings For Search Settings 
15. Top Level Menu Settings - Icon Settings 
16. Sub Level Menu Settings - Sub Menu Settings 
17. Sub Level Menu Settings - Sub Menu Second Settings 
18. Sub Level Menu Settings - Icon Settings 
19. Sub Level Menu Settings - Enable Custom Menu Settings
20. Sub Level Menu Settings - Custom Menu Settings Options
21. Sub Level Menu Settings - Featured Image Settings
22. Sub Level Menu Settings - Custom Image Settings
23. Custom Theme Settings - Custom Theme Add/Edit Customization Settings
24. Frontend Horizontal Menu Demo
...
= 2.0.3 =
* Few Frontend CSS Refinement work done.

= 2.0.2 =
* Session Used Removed.
* CSS and Frontend JS refinement done.

= 2.0.1 =
* Fixed Issue: Fixed issue related with displaying Open Sans array value.

= 2.0.0 =
* Fixed Issue: Fixed issue related with menu icon on walker class.
* Refining CSS/JS: Refining works on CSS and JS.

= 1.0.9 =
* Fixed Issue: Text Widget compatibility issue fixed on backend.
* Fixed Issue: Menu Icon and down arrow not showing issue resolved.
* Refining CSS/JS: Refining works on CSS and JS.

= 1.0.8 =
* Added Feature: 2 Pre Available Custom Widget Available for adding Html text and to upload custom image for mega menu content. Go to Add widget button, AP Mega Menu Widget, we can get 2 extra widget as AP Mega Menu: HTML Text to add any html content, embed youtube , vimeo script and AP Mega Menu: Custom Image Widget.
* Fixed Issue: Resolved Issue related with CSS Conflict with Theme's Woocommerce Product Display.
* Refining CSS/JS: Refining works on CSS and JS.

= 1.0.7 =
* Issue Fixed: Menu hover issues due to css conflict resolved.
* Compatibility: Plugin Compatible with latest WP version 4.9
* Refining CSS/JS: Refining works on CSS and JS.

= 1.0.6 =
* Issue Fixed: Hide Mega Menu on Desktop issue fixed on mobile version.
* Refining CSS/JS: Refining works on CSS and checked theme compatibility with Flatsome theme.

= 1.0.5 =
* Issue Fixed: Hide Mega Menu on mobile issue fixed from Common General Mobile settings.
* Refining CSS/JS: Refining works done on css and js files.

= 1.0.4 =
* Issue Fixed: Sub Menu and Mega Menu Display on mobile version issue resolved.
* Issue Fixed: Vertical menu with responsive issue fixed.
* Refining CSS/JS: Refining works done on css and js files.
...
== Upgrade Notice ==
There is an update available for the AP Mega Menu Plugin. Please update to receive new updates and bug fixes.
